...
\begin{itemize}
  ...
  \item \textbf{Creación de un crontab}:
        % \begin{figure}
        %   \centering
        %   \includegraphics[scale=0.43]{img/UbuntuServer/UbuntuServer_Base_5.png}
        %   \caption{Creación de un crontab}
        % \end{figure}
...
\begin{itemize}
  ...
  \item \textbf{Creación de un archivo en la raíz web}: 10.6.129.208; echo "Hola, este es mi archivo" \textbar \space sudo tee /var/www/html/miarchivo.html
        \begin{figure}[H]
          \centering
          \includegraphics[scale=0.35]{img/CentOS/Centos7_Base_2.png}
          \caption{Creación de un archivo en la raíz web}
        \end{figure}
  \item \textbf{Inyección de comandos (con éxito)}:
        \begin{figure}[H]
          \centering
          \includegraphics[scale=0.5]{img/CentOS/Centos7_Base_3.png}
          \caption{Inyección del comando \emph{ls} con éxito}
        \end{figure}
  \item \textbf{cat \emph{/etc/passwd}}:
        \begin{figure}[H]
          \centering
          \includegraphics[scale=0.43]{img/CentOS/Centos7_Base_4.png}
          \caption{Visualización del contenido del archivo \emph{/etc/passwd}}
        \end{figure}
  \item \textbf{Creación de un crontab}:
        % \begin{figure}
  ...
  \item \textbf{Obtener un fichero por \emph{wget}}:
        \begin{figure}[H]
          \centering
          \includegraphics[scale=0.4]{img/CentOS/Centos7_Base_6.png}
          \caption{Obtención de un fichero por \emph{wget}}
        \end{figure}
  \item \textbf{Reverse Shell}:
\end{itemize}
